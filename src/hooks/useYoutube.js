...
//비동기 데이터가 inactive가 되면 무조건 캐시타임이 카운트됨 
//inactive가 아닌 상태에서 data가 stale상태면 refetching 발생
//inactive상태가 아니고 아직 fresh상태이면 refetching 발생 X

//react-query로 관리하는 서버데이터가 만약 24시간 주기로 변경된다고 하면 
//staleTime을 24시간으로 지정해서 24시간안에는 refetching 하지 않도록 처리
